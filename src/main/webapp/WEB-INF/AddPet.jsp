...
<div style="float: left">
    <form:form method="POST" action="/addPet/${id}" modelAttribute="pet">
        ...
        <div class="mb-3 row">
            ...
            <form:input type="number" path="age" min="0" max="20" class="form-control"/> Years
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            <form:label path="size" class="col-sm-2 col-form-label">Size:</form:label>
        ...
        <div class="mb-3 row">
            <form:label path="breed" class="col-sm-2 col-form-label">Breed:</form:label>
            <form:input path="breed" class="form-control"/>
        </div>
        <div class="form-group">
            <form:label path="notes" class="col-sm-2 col-form-label">Notes:</form:label>
            <form:textarea path="notes"  placeholder="Leave notes here"  style="height: 100px  width:200px" class="form-control"></form:textarea>
        </div>

        <input type="submit" value="Add Pet" type="button" class="btn btn-secondary"/>
    </form:form>
</div>
